...
(function($PS) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("What is your name?") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($11) {
          return Data_Maybe.Just.create(UpdateName.create($11));
      }) ]), hello ]);
  };
  var initialState = {
      name: ""
  ...
  var page = Halogen_Component.mkComponent({
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(page)(Data_Unit.unit)(v);
  }));
